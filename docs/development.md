...
| `tools/icon` | MAYAK のマーク（六角形と M）を `build/appicon.png`（1024px。トレイと macOS の ICNS の元）、`build/windows/icon.ico`（16〜256px）、`frontend/public/favicon-32.png` に描き、`favicon.svg` の色も揃える。`go run ./tools/icon -bg 1a1a1a -fg f2f2f2`（サイトと同じ白黒）。 |
