    ...
    <footer className="border-t">
      <div className="text-muted-foreground mx-auto max-w-6xl px-4 py-10 text-xs leading-relaxed sm:px-6">
        <div className="mb-4 flex items-center gap-2.5">
          <img src="/assets/mayak-mark.png" alt="" width={24} height={24} className="size-6 rounded" />
        ...
        <p className="mt-3 flex flex-wrap gap-4">
          ...
          <a href={`https://github.com/${REPOSITORY}/blob/main/LICENSE`} rel="noopener" className="hover:text-foreground">
            {t.footer.license}
          </a>
