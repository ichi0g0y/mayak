export const ja = {
  ...
  download: {
    ...
    windowsSteps: ['Mayak-Setup-x.y.z-windows-amd64.exe を実行する', 'SmartScreen が出たら「詳細情報」→「実行」', '完了すると MAYAK が起動し、スタートメニューに登録される'],
    macSteps: ['dmg を開いて Mayak.app を Applications にドラッグする', '初回は右クリック →「開く」（「開発元を確認できない」と出たら システム設定 → プライバシーとセキュリティ →「このまま開く」）'],
    linuxSteps: ['tar xzf Mayak-x.y.z-linux-amd64.tar.gz', 'chmod +x Mayak && ./Mayak', 'WebKitGTK（libwebkit2gtk-4.1 / GTK 4）が必要'],
    installer: 'インストーラー',
    portable: 'ポータブル版 (zip)',
    mac: 'macOS',
  ...
  faq: {
    ...
    title: 'よくある質問',
    items: [
      { q: 'MAYAK は何と読みますか？', a: '「マヤーク」と読みます。ロシア語で灯台を意味する маяк から取りました。ロゴが灯台なのもそのためです。' },
