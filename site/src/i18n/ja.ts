export const ja = {
  ...
  start: {
    ...
    steps: [
      ...
      { title: '（任意）TarkovTracker で進捗を自動記録', body: 'TarkovTracker はタスクの進捗を管理できる無料のサイトです。MAYAK と繋ぐと、ゲーム内でタスクを受注・完了・失敗したときに自動で反映されます。繋ぎ方: TarkovTracker の Settings → API Tokens で GP と WP にチェックしてトークンを作り、MAYAK の設定「TarkovTracker」に貼り付け、ログから見つかったプロフィール（PvP / PvE）に割り当てるだけです。' },
    ],
