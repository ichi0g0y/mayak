...
export const en: Messages = {
  ...
  start: {
    ...
    steps: [
      ...
      { title: '(Optional) Let TarkovTracker record your progress', body: 'TarkovTracker is a free site that tracks your task progress. Connected to MAYAK, it updates itself when you accept, complete or fail a task in game. To connect: on TarkovTracker go to Settings → API Tokens, create a token with GP and WP checked, paste it under Settings → TarkovTracker in MAYAK and assign it to the profile (PvP / PvE) found in the logs.' },
    ],
