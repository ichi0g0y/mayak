...
export const en: Messages = {
  ...
  start: {
    ...
    steps: [
      ...
      { title: 'Put the screenshot key within reach', body: 'In EFT go to Settings → Controls → "Screenshot". The default is PrintScreen, which is hard to reach mid-fight, so bind it to a mouse side button or a free key near your left hand (left Ctrl + 1, for example). Only screenshots taken with EFT’s own function carry coordinates; Steam or Windows screenshots do not.' },
