...
Object.assign(words.ja,{tutorialShow:'チュートリアルを表示',tutorialShowHelp:'初回起動時の案内（フォルダ、スクリーンショットキー、マップ、TarkovTracker）をもう一度見ます。',tutStep:'ステップ',tutStart:'はじめる',tutLater:'あとで',tutNext:'次へ',tutBack:'戻る',tutSkip:'スキップ',tutFinish:'完了',
 tutWelcomeTitle:'MAYAK へようこそ',tutWelcome:'ゲーム内で撮影したスクリーンショットとログを読むだけで、マップ・タスク・アイテム情報をこのウインドウに映します。ゲーム本体には触れません。この案内に沿って進めれば、準備は数分で終わります。',
 ...
 tutMapTitle:'レイド中はそのキーを押すだけ',tutMap:'このウインドウのマップタブは、設定なしで現在地に追従します。タスク一覧で該当のタスクを開いた状態か、アイテム詳細を撮れば、それぞれの情報も表示されます（一覧だけの画面ではどのタスクか分かりません）。1 台の PC でマルチモニタなら、これで完結です。',tutOpenMap:'マップを開く',
 tutRemoteTitle:'別の PC や普段のブラウザで見るなら（任意）',tutRemote:'そのブラウザで tarkov.dev のマップを開き、左下の接続ボタンを押します。同じ PC の Chrome / Edge / Brave なら Remote ID は自動検出、別の PC やタブレットなら ID を入力します。別の PC で MAYAK 自体を動かすなら、設定 → 他のPCとの接続 の 8 桁の接続コードで繋がります。',tutOpenRemote:'tarkov.dev 連携の設定を開く',
...
Object.assign(words.en,{tutorialShow:'Show the tutorial',tutorialShowHelp:'See the first-run guide again: folders, the screenshot key, the map and TarkovTracker.',tutStep:'Step',tutStart:'Get started',tutLater:'Later',tutNext:'Next',tutBack:'Back',tutSkip:'Skip',tutFinish:'Done',
 tutWelcomeTitle:'Welcome to MAYAK',tutWelcome:'MAYAK reads only the screenshots you take in the game and the logs it writes, and shows maps, tasks and item info in this window. It never touches the game itself. Follow this guide and setup takes a few minutes.',
 ...
 tutMapTitle:'In a raid, just press that key',tutMap:'The map tab in this window follows your position with no setup. Screenshot a task opened in the Tasks screen, or an item window, and that info appears too (the list alone does not show which task). On one PC with several monitors, that is all you need.',tutOpenMap:'Open the map',
 tutRemoteTitle:'Another PC or your usual browser (optional)',tutRemote:'Open the tarkov.dev map there and click the connect button at the bottom left. Chrome, Edge and Brave on this PC are detected automatically; from another PC or a tablet, type the Remote ID in. To run MAYAK itself on another PC, pair it with the 8-digit code under Settings → Other computers.',tutOpenRemote:'Open the tarkov.dev settings',
...
Object.assign(words.ja,{allTabs:'すべてのタブ',searchTabs:'タブを検索',tabsHint:'開いているタブを名前とアドレスで探せます。クリックで切り替え、× で閉じます。',noTabResults:'一致するタブはありません。',tabsClose:'タブを閉じる',updateSection:'アップデート',updateCurrent:'現在の版',updateLatest:'最新の版',updateCheck:'更新を確認',updateChecking:'確認しています…',updateCheckedAt:'最終確認',updateUpToDate:'最新の版です',updateNever:'まだ確認していません',updateUnsupported:'このプラットフォーム向けのビルドがありません',updateError:'確認できませんでした',updateAutoNote:'自動更新は 設定 → 起動とウィンドウ で切り替えられます。',updateDownloading:'MAYAK {v} をダウンロード中',updateReady:'MAYAK {v} の準備ができました',updateRestart:'再起動して適用',updateDownload:'ダウンロード',updateLater:'あとで',updateNotes:'変更点',updateReadyHint:'いま適用しなくても、次に MAYAK を終了したときに入れ替わります。'});
Object.assign(words.en,{allTabs:'All tabs',searchTabs:'Search tabs',tabsHint:'Every open tab, by name and address. Click one to switch to it, × to close it.',noTabResults:'No tabs match.',tabsClose:'Close tab',updateSection:'Updates',updateCurrent:'This version',updateLatest:'Latest version',updateCheck:'Check for updates',updateChecking:'Checking…',updateCheckedAt:'Last checked',updateUpToDate:'Up to date',updateNever:'Not checked yet',updateUnsupported:'No build for this platform',updateError:'Could not check',updateAutoNote:'Automatic updates are switched under Settings → Startup & window.',updateDownloading:'Downloading MAYAK {v}',updateReady:'MAYAK {v} is ready',updateRestart:'Restart to apply',updateDownload:'Download',updateLater:'Later',updateNotes:'What changed',updateReadyHint:'If you do not apply it now, it is installed when MAYAK next quits.'});
