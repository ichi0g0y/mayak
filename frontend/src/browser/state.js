...
const themes = ['system','claude-dark','claude-light','catppuccin-latte','catppuccin-frappe','catppuccin-macchiato','catppuccin-mocha','nord','dracula','gruvbox-dark','tokyo-night','solarized-dark','solarized-light'];
